...
public class GameManager implements IGameManager {
    ...
    protected Vector<Report> checkDropBAFromConverting(Entity carrier, Entity rider, Coords curPos, int curFacing,
        ...
        if (falls) {
            ...
            } else if (!entityActionManager.unloadUnit(carrier, rider, curPos, curFacing, 0, this)) {
    ...
    protected void checkLayExplosives() {
        ...
        for (Building.DemolitionCharge charge : explodingCharges) {
            ...
            r.add(bldg.getName());
            addReport(r);
            Vector<Report> dmgReports = environmentalEffectManager.damageBuilding(bldg, charge.damage, " explodes for ", charge.pos, this);
            ...
            if (entity.hasInfernoAmmo()) {
                ...
                if (entity.heat >= 10) {
                    ...
                    if (rollValue >= boom) {
                        ...
                        r.choose(false);
                        addReport(r);
                        reportManager.addReport(environmentalEffectManager.explodeInfernoAmmoFromHeat(entity, this), this);
                    }
                }
    ...
    protected void doFlamingDamage(final Entity entity, final Coords coordinates) {
        ...
        if (diceRoll.getIntValue() >= 8) {
            ...
            if (entity instanceof GunEmplacement) {
                ...
                Report.addNewline(vPhaseReport);
                reportManager.addReport(environmentalEffectManager.criticalGunEmplacement(gun, building, entity.getPosition(), this), this);
        ...
        for (Iterator<Entity> i = game.getEntities(); i.hasNext(); ) {
            ...
            if ((entity.getTraitorId() != -1) && (entity.getOwnerId() != entity.getTraitorId())) {
                ...
                if (newPlayer != null) {
                    ...
                    entityActionManager.entityUpdate(entity.getId(), this);
                    vFullReport.add(r);
    ...
    public Vector<Report> damageEntity(Entity te, HitData hit, int damage,
        ...
        while (damage > 0) {
            ...
            if (te.hasWorkingMisc(MiscType.F_SPIKES, -1, hit.getLocation())) {
                vDesc.add(environmentalEffectManager.checkBreakSpikes(te, hit.getLocation()));
            }
    ...
    protected int damageExternalPassenger(Entity te, HitData hit, int damage, Vector<Report> vDesc,
        ...
        if (passenger.hasETypeFlag(Entity.ETYPE_PROTOMECH)
            ...
            entityActionManager.unloadUnit(te, passenger, position, facing, te.getElevation(), false, false, this);
            ...
            if (violation != null) {
                ...
                entityActionManager.entityUpdate(violation.getId(), this);
            }
        }
        return damage;
    }
        ...
        while (buildings.hasMoreElements()) {
            ...
            while (hexes.hasMoreElements()) {
                ...
                if (dist < damages.length) {
                    Vector<Report> buildingReport = environmentalEffectManager.damageBuilding(bldg, damages[dist], coords, this);
    ...
    protected Vector<Report> doEntityFall(Entity entity, Coords fallPos, int fallHeight, int facing,
        ...
        if (Entity.NONE != swarmerId) {
            ...
            swarmer.setPosition(fallPos);
            entityActionManager.entityUpdate(swarmerId, this);
            if (!swarmer.isDone()) {
        ...
        if (checkCollapse && !handlingBasement) {
            ...
            environmentalEffectManager.checkForCollapse(game.getBoard().getBuildingAt(fallPos),
                    game.getPositionMap(), fallPos, false, vPhaseReport, this);
        }
    ...
    public void addSmoke(ArrayList<Coords> coords, int windDir, boolean bInferno) {
        ...
        environmentalEffectManager.createSmoke(coords, smokeLevel, 0, this);
    }
    ...
    protected Vector<Player> whoCanSee(Entity entity, boolean useSensors,
        ...
        if (bTeamVision) {
            entityActionManager.addTeammates(vCanSee, entity.getOwner(), this);
        }
        ...
        for (Entity spotter : vEntities) {
            ...
            if (Compute.canSee(game, spotter, entity, useSensors, los,
                ...
                if (bTeamVision) {
                    entityActionManager.addTeammates(vCanSee, spotter.getOwner(), this);
                }
                entityActionManager.addObservers(vCanSee, this);
            }
        }
        return vCanSee;
    }
    ...
    protected Vector<Report> filterReportVector(Vector<Report> originalReportVector, Player p) {
        ...
        if (!environmentalEffectManager.doBlind(this)) {
    ...
    protected void updateVisibilityIndicator(Map<EntityTargetPair, LosEffects> losCache) {
        ...
        for (Entity e : vAllEntities) {
            ...
            Vector<Player> vCanDetect = entityActionManager.whoCanDetect(e, allECMInfo, losCache, this);
            ...
            if (hasClientWithoutEntity) {
                entityActionManager.entityUpdate(e.getId(), new Vector<>(), false, losCache, this);
            } else {
        ...
        if (entity instanceof Mech || entity.isFighter()) {
            ...
            if (entity.getCrew().isDoomed()) {
                ...
                if (game.getBoard().contains(targetCoords)) {
                    ...
                    vDesc.addElement(r);
                    // Update the entity
                    entityActionManager.entityUpdate(pilot.getId(), this);
            ...
            entityActionManager.entityUpdate(crew.getId(), this);
    ...
    public Vector<Report> ejectSpacecraft(Aero entity, boolean inSpace, boolean airborne, Coords pos) {
        ...
        if ((inSpace && (entity.getPodsLeft() > 0 || entity.getLifeBoatsLeft() > 0))
            ...
            // Sent entity info to clients
            entityActionManager.entityUpdate(pods.getId(), this);
            if (game.getOptions().booleanOption(OptionsConstants.ADVGRNDMOV_EJECTED_PILOTS_FLEE)) {
    ...
    public Vector<Report> vehicleMotiveDamage(Tank te, int modifier) {
        return entityActionManager.vehicleMotiveDamage(te, modifier, false, -1, false, this);
    }

    protected Vector<Report> vehicleMotiveDamage(Tank te, int modifier, boolean noRoll,
                                               int damageType) {
        return entityActionManager.vehicleMotiveDamage(te, modifier, noRoll, damageType, false, this);
    }
